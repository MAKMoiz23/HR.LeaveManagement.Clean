...
public class UpdateLeaveAllocationValidator : AbstractValidator<UpdateLeaveAllocationCommand>
{
    ...
    public UpdateLeaveAllocationValidator(ILeaveAllocationRepository leaveAllocationRepository)
    {
        ...
        RuleFor(lt => lt.Id)
            .NotNull()
                .WithMessage("LeaveAllocation Id is required");
    ...
    private async Task<bool> AllocationExists(UpdateLeaveAllocationCommand command, CancellationToken cancellationToken)
    {
